...
>>>>>>> Stashed changes
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        claim = ClaimListController.getInstance().getSelectedClaim(); //why problem?
...
=======
    ...
    private void updateClaimInfo(View v){
    	...
    	claimStart.setText(claim.getStartDate()); //Does not work with Gregorian Calendar
    	final TextView claimEnd = (TextView) findViewById(R.id.detailsEndDate);
    	claimEnd.setText(claim.getStartDate()); //Does not work with Gregorian Calendar
